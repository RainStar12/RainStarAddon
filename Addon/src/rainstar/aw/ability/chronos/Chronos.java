package rainstar.aw.ability.chronos;

import rainstar.aw.effect.TimeInterrupt;
...
@AbilityManifest(name = "크로노스", rank = Rank.S, species = Species.GOD, explain = {
		...
		" §f이동 속도§7 · §f공격 속도§7 · §f쿨타임을 §e느리게§f 흐르게 하고,",
		" §f지속 시간§7 · §f기본 무적 시간§f을 §b빠르게§f 흐르게 합니다. $[COOLDOWN]",
