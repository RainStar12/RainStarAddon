...
import rainstar.aw.ability.*;
import rainstar.aw.ability.chronos.Chronos;
import rainstar.aw.ability.timestop.TimeStop;
import rainstar.aw.synergy.*;
...
import rainstar.aw.synergy.chance.Chance;
...
public class AddonR extends Addon implements Listener {
	...
	public void onEnable() {
		...
		AbilityFactory.registerAbility("rainstar.aw.ability.theonering." + ServerVersion.getName() + ".TheOneRing");
		AbilityList.registerAbility("rainstar.aw.ability.theonering." + ServerVersion.getName() + ".TheOneRing");
		//70
