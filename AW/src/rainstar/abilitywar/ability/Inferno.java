...
@AbilityManifest(name = "인페르노", rank = Rank.S, species = Species.DEMIGOD, explain = {
		...
		" 나를 포함한 모든 대상에게 §4§n화상§f 상태이상을 겁니다. $[COOLDOWN]",
		" §4§n화상§f이 지속하는 동안, 자신은 화염계 피해의 절반만큼 역으로 회복합니다.",
		"§c[§4화상§c]§f 모든 화염 계열 피해를 무시할 수 없으며 2.5배로 입습니다.",
		...
		"§7철괴 우클릭 시§f 나와 주변 대상들을 $[DURATION]초 추가 발화시키며, §4§n화상§f을 겁니다.",
		"§4§n화상§f에 걸린 적은 화염계 피해를 무조건 받으며 2.5배로 입습니다.",
		"본인은 §4§n화상§f 지속시간 동안 화염계 피해를 역회복합니다."
		})
