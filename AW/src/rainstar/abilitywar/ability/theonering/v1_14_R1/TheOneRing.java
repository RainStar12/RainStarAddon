package rainstar.abilitywar.ability.theonering.v1_14_R1;
...
import rainstar.abilitywar.ability.theonering.AbstractTheOneRing;
...
public class TheOneRing extends AbstractTheOneRing {

	private static final DataWatcherObject<Byte> BYTE_DATA_WATCHER_OBJECT;

	static {
		try {
			BYTE_DATA_WATCHER_OBJECT = FieldUtil.getStaticValue(Entity.class, "W");
	...
	public TheOneRing(Participant participant) {
		super(participant);
	}
