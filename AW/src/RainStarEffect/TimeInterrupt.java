...
@EffectManifest(name = "시간 조작", displayName = "§3시간 조작", method = ApplicationMethod.UNIQUE_STACK, type = {
		EffectType.ABILITY_RESTRICTION, EffectType.MOVEMENT_INTERRUPT, EffectType.COMBAT_RESTRICTION
}, description = {
		"§f이동 속도§7 · §f공격 속도§7 · §f쿨타임이 §e느려지며§f,",
		"§f지속 시간§7 · §f기본 무적 시간§f이 §b빠르게§f 흐릅니다."
})
