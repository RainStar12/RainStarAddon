	...
	private void onEntityDamageByEntity(EntityDamageByEntityEvent e) {
		if (e.getDamager().equals(player)) {
			if (random.nextInt(10) == 0) {
				...
				player.sendMessage("§c아~ 싸움 그렇게 하는 거 아닌데~");
			}
		}
	}
	...
	public void onEntityShootBow(EntityShootBowEvent e) {
		if (e.getEntity().equals(player)) {
			if (random.nextInt(20) == 0) {
				PotionEffects.BLINDNESS.addPotionEffect(player, 40, 0, true);
				SoundLib.ENTITY_WITCH_AMBIENT.playSound(player, 1, 1.5f);
				player.sendMessage("§c아~ 활 그렇게 쏘는 거 아닌데~");
			}
		}
	}
	...
	public void onPlayerDrop(PlayerDropItemEvent e) {
		if (e.getPlayer().equals(player)) {
			if (random.nextInt(10) == 0) {
				PotionEffects.BLINDNESS.addPotionEffect(player, 40, 0, true);
				SoundLib.ENTITY_WITCH_AMBIENT.playSound(player, 1, 1.5f);
				player.sendMessage("§c아~ 템 그렇게 떨구는 거 아닌데~");
			}
		}
	}
	...
	public void onPlayerSwapHandItems(PlayerSwapHandItemsEvent e) {
		if (e.getPlayer().equals(player)) {
			if (random.nextInt(10) == 0) {
				PotionEffects.BLINDNESS.addPotionEffect(player, 40, 0, true);
				SoundLib.ENTITY_WITCH_AMBIENT.playSound(player, 1, 1.5f);
				player.sendMessage("§c아~ 스왑 그렇게 하는 거 아닌데~");
			}
		}
	}
	...
	public void onBlockBreak(BlockBreakEvent e) {
		if (e.getPlayer().equals(player)) {
			if (random.nextInt(40) == 0) {
				PotionEffects.BLINDNESS.addPotionEffect(player, 40, 0, true);
				SoundLib.ENTITY_WITCH_AMBIENT.playSound(player, 1, 1.5f);
				player.sendMessage("§c아~ 블록 그렇게 부수는 거 아닌데~");
			}
		}
	}
	...
	public void onBlockPlace(BlockPlaceEvent e) {
		if (e.getPlayer().equals(player)) {
			if (random.nextInt(40) == 0) {
				PotionEffects.BLINDNESS.addPotionEffect(player, 40, 0, true);
				SoundLib.ENTITY_WITCH_AMBIENT.playSound(player, 1, 1.5f);
				player.sendMessage("§c아~ 블록 그렇게 설치하는 거 아닌데~");
			}
		}
	}
	...
	public void onVehicleEnter(VehicleEnterEvent e) {
		if (e.getEntered().equals(player)) {
			if (random.nextInt(4) == 0) {
				PotionEffects.BLINDNESS.addPotionEffect(player, 40, 0, true);
				SoundLib.ENTITY_WITCH_AMBIENT.playSound(player, 1, 1.5f);
				player.sendMessage("§c아~ 그렇게 타는 거 아닌데~");
			}
		}
	}
	...
	private void onAbilityActiveSkill(AbilityActiveSkillEvent e) {
		if (e.getPlayer().equals(player)) {
			if (random.nextInt(2) == 0) {
				PotionEffects.BLINDNESS.addPotionEffect(player, 40, 0, true);
				SoundLib.ENTITY_WITCH_AMBIENT.playSound(player, 1, 1.5f);
				player.sendMessage("§c아~ 능력 그렇게 쓰는 거 아닌데~");
			}
		}
	}
	...
	private void onPlayerMove(PlayerMoveEvent e) {
		if (e.getPlayer().equals(player)) {
			if (random.nextInt(1000) == 0) {
				PotionEffects.BLINDNESS.addPotionEffect(player, 40, 0, true);
				SoundLib.ENTITY_WITCH_AMBIENT.playSound(player, 1, 1.5f);
				player.sendMessage("§c아~ 무빙 그렇게 치는 거 아닌데~");
			}
		}
	}
	...
	public void onEntityPickupItem(EntityPickupItemEvent e) {
		if (e.getEntity().equals(player)) {
			if (random.nextInt(40) == 0) {
				PotionEffects.BLINDNESS.addPotionEffect(player, 40, 0, true);
				SoundLib.ENTITY_WITCH_AMBIENT.playSound(player, 1, 1.5f);
				player.sendMessage("§c아~ 파밍 그렇게 하는 거 아닌데~");
			}
		}
	}
	...
	private void onEntityRegainHealth(EntityRegainHealthEvent e) {
		if (e.getEntity().equals(player)) {
			if (random.nextInt(20) == 0) {
				PotionEffects.BLINDNESS.addPotionEffect(player, 40, 0, true);
				SoundLib.ENTITY_WITCH_AMBIENT.playSound(player, 1, 1.5f);
				player.sendMessage("§c아~ 회복 그렇게 하는 거 아닌데~");
			}
		}
	}
